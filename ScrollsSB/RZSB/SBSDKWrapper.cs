...
namespace Razer.SwitchbladeSDK2
{
    ...
    /// </summary>
    public enum SWITCHBLADE_HARDWARE_TYPE : uint
    {
        HARDWARETYPE                = 0,
    ...
    /// </summary>
    public enum DYNAMICKEY_DISPAY_REGION
    {
    ...
    /// </summary>
    public enum TOUCHPAD_DISPLAY_REGION : uint
    {
    ...
    /// </summary>
    public enum SWITCHBLADESDK_DEFINE_CONSTANTS : int
    {
    ...
    /// </summary>
    public enum SWITCHBLADESDK_TYPE_CONSTANTS : int
    {
    ...
    public struct RZSBSDK_QUERYCAPABILITIES
    {
    ...
    /// </summary>
    public enum RZSBSDK_KEYSTATETYPE
    {
    ...
    /// </summary>
    public enum RZSBSDK_DIRECTIONTYPE
    {
    ...
    /// </summary>
    public enum RZSBSDK_STATICKEYTYPE : int
    {
    ...
    /// </summary>
    public enum RZSBSDK_DKTYPE : int
    {
        RZSBSDK_DK_NONE = 0,
        RZSBSDK_DK_1,
        RZSBSDK_DK_2,
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public struct RZSBSDK_BUFFERPARAMS
    {	
	    public PIXEL_TYPE	PixelType;
	    public int		    DataSize;	// Buffer size
    ...
    /// </summary>
    public enum RZSBSDK_GESTURETYPE : uint
    {
    ...
    /// </summary>
    public enum RZSBSDK_EVENTTYPETYPE : int
    {
    ...
    /// </summary>
    public enum STANDARD_HRESULT : uint
    {
        S_OK                    = 0,
        E_FAIL                  = 0x80004005,
    ...
    /// </summary>
    public enum RZSBSDK_HRESULT : uint
    {
    ...
    /// <returns></returns>
    public delegate RZSBSDK_HRESULT AppEventCallbackTypeDelegate(RZSBSDK_EVENTTYPETYPE rzEventType, UInt32 dwParam1, UInt32 dwParam2);
    ...
    /// <returns></returns>
    public delegate RZSBSDK_HRESULT DynamicKeyCallbackDelegate(RZSBSDK_DKTYPE dynamicKey, RZSBSDK_KEYSTATETYPE dynamicKeyState);
    ...
    /// <returns></returns>
    public delegate RZSBSDK_HRESULT TouchpadGestureCallbackDelegate(RZSBSDK_GESTURETYPE gesture, UInt32 dwParameters, UInt16 wXPos, UInt16 wYPos, UInt16 wZPos);
    ...
    /// <returns></returns>
    public delegate RZSBSDK_HRESULT KeyboardCallbackTypeDelegate(uint uMsg, UIntPtr wParam, IntPtr lParam);

    public class RZSBSDKAPI
    {
        ...
        public static extern RZSBSDK_HRESULT RzSBStart();
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBQueryCapabilities(IntPtr capabilities);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBRenderBuffer(RZSBSDK_DISPLAY targetDisplay, IntPtr bufferParams);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBSetImageDynamicKey(RZSBSDK_DKTYPE dynamicKey, RZSBSDK_KEYSTATETYPE dynamicKeyState, 
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBSetImageTouchpad([MarshalAsAttribute(UnmanagedType.LPWStr)] string filename);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBEnableGesture(RZSBSDK_GESTURETYPE gestureType, bool bEnable);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBEnableOSGesture(RZSBSDK_GESTURETYPE gestureType, bool bEnable);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBCaptureKeyboard(bool bEnable);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBAppEventSetCallback(AppEventCallbackTypeDelegate callback);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBDynamicKeySetCallback(DynamicKeyCallbackDelegate callback);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBGestureSetCallback(TouchpadGestureCallbackDelegate callback);
        ...
        /// <returns>HRESULT of the operation</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern RZSBSDK_HRESULT RzSBKeyboardCaptureSetCallback(KeyboardCallbackTypeDelegate callback);
